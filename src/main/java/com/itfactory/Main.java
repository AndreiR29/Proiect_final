...
public class Main {
    public static void main(String[] args) {
        ...
        switch (option) {
            case 1:
                System.out.println("Introduceti lungimea laturii 1: ");
                double side1 = sc.nextDouble();
                System.out.println("Introduceti lungimea laturii 2: ");
                double side2 = sc.nextDouble();
                System.out.println("Introduceti lungimea laturii 3: ");
                ...
                break;
            case 2:
                System.out.println("Introduceti lungimea laturii patratului:");
